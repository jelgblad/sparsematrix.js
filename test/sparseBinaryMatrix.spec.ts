...
describe('SparseBinaryMatrix', function () {
    describe('.getIndex()', function () {
        ...
        var matrix2d = new SparseBinaryMatrix([4, 8]);
    ...
    describe('.getCoordinates()', function () {
        ...
        var matrix = new SparseBinaryMatrix([3, 7, 5]);
    ...
    describe('.getSize()', function () {
        ...
        var matrix2d = new SparseBinaryMatrix([4, 8]);
        var matrix3d = new SparseBinaryMatrix([4, 8, 16]);
        var matrix4d = new SparseBinaryMatrix([4, 8, 16, 32]);
